const BecomeInvestors = () => {
  return (
    <div className="grid  grid-cols-2 lg:grid-cols-3 gap-18 mt-20 bg-green-700 p-10 rounded-md">
      <div>
        <h3 className="text-xl sm:2xl lg:text-4xl font-bold text-white">Become An <br /> Investors</h3>
      </div>
      <div>
        <h2 className="text-lf sm:xl lg:text-2xl  font-bold text-white"> Contact Us</h2>
      ...
      <div className="mt-10 flex items-center">
        <input
          name="user_email"
          type="text"
          className="border py-2 focus:outline-[#275998]  -sm   pl-[14px]"
          placeholder="Email-ID"
        />
        <input
          type="submit"
          value="Send"
          className=" px-4  text-black bg-[#f4e5c2] rounded- font-medium py-[9px] cursor-pointer"
        />
      </div>{" "}
    </div>
  );
