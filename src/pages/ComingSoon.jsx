...
const ComingSoon = () => {
    return (
        ...
        <h1 className="text-6xl font-bold text-green-800 animate-bounce">Coming Soon</h1>
        <p className="text-xl text-green-700 mt-4">Triogen Export is growing. Stay tuned!</p>
