  ...
  return (
    <>
      <Helmet prioritizeSeoTags>
        <title>
          Our Products || Premium Eco-Friendly Cocopeat Solutions - Triogen
          Exports
        </title>
        <meta
          property="og:title"
          content="Our Products || Premium Eco-Friendly Cocopeat Solutions - Triogen Exports"
        />
        <meta
          property="og:description"
          content="Discover Triogen Exports’ range of high-quality cocopeat products designed to enhance soil health and boost sustainable agricultural practices. From cocopeat blocks to grow bags, our eco-friendly solutions cater to diverse agricultural needs, ensuring optimal growth and environmental responsibility.
           Explore our product offerings and choose the best for your farm or garden"
        />
        <meta
          property="og:url"
        ...
        <div className="p-6 md:p-20">
          ...
          >
            <div style={{ fontFamily: "Montserrat, sans-serif" }}>
              ...
              vegetables, flowers, and herbs, it promotes strong root growth
              while providing excellent drainage. Ideal for both indoor and
              outdoor gardening. Sustainable, lightweight, and easy to use!
            </div>
            <div>
              <h1
          ...
          >
            <div style={{ fontFamily: "Montserrat, sans-serif" }}>
              ...
              hydration. Long-lasting and reusable,{` they’re`} a great choice
          ...
          >
            ...
            <div style={{ fontFamily: "Montserrat, sans-serif" }}>
              ...
              help retain moisture while suppressing unwanted weeds. They
              provide excellent aeration to the soil and are biodegradable,
              making them perfect for sustainable gardening. Easy to install and
              long-lasting, Coco Weed Mats keep your plants healthy and
              weed-free!
            </div>
          </motion.header>
          ...
          >
            <div style={{ fontFamily: "Montserrat, sans-serif" }}>
              ...
              for green-thumb enthusiasts and commercial growers alike!Coco
              Fibre Bales are a sustainable, eco-friendly solution for gardening
              and agriculture. Made from natural coconut husks, these bales
              provide excellent aeration and drainage for soil, promoting
              healthier root growth. They are perfect for mulching, soil
              conditioning, and erosion control. Long-lasting and biodegradable,
              coco fibre bales improve plant productivity and soil health. Ideal
              for green-thumb enthusiasts and commercial growers alike!
            </div>
            <div>
              <h1
                style={{ fontFamily: "Montserrat, sans-serif" }}
          ...
          >
            ...
            <div style={{ fontFamily: "Montserrat, sans-serif" }}>
              ...
              breathable, and promote soil stabilization when used in
              landscaping projects. Perfect for those seeking eco-conscious
              alternatives, coir textiles combine functionality with
              sustainability.
            </div>
          </motion.header>
